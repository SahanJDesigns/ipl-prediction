...
export default function PlayerDashboard() {
    const player = {
        ...
        battingRadar: [
        { subject: "Strike Rate", A: 140, B: 11 },
        { subject: "Average", A: 31, B: 9 },
        { subject: "Fifties Rate", A: 0.05, B: 0.04 },
        { subject: "Boundary %", A: 0.7, B: 0.8 },
        { subject: "Runs", A: 192, B: 15 },
        { subject: "Not Outs", A: 12, B: 10 },
        ],
        bowlingRadar: [
        { subject: "Wickets", A: 10, B: 20 },
        { subject: "Economy", A: 10, B: 8.0 },
        { subject: "Average", A: 15, B: 30 },
        { subject: "Strike Rate", A: 10, B: 20 },
        ],
        yearlyData:
        [
